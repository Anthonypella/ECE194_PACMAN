...
public class GhostMovePink : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        pacMove = pacman.GetComponent<tweenMove>();
    ...
    void startUp()
    {
        ...
        hasLeft = true;
        startPos = getRoundedPos() + Vector2.right * 2f;
    ...
    void endTween()
    {
        ...
        {
            case State.chase:
                targetPoint = (Vector2)pacman.position + pacMove.getDirection()*4f;
                break;
            case State.scatter:
